...
func main() {
	...
	http.HandleFunc("/u/{username}/{projectName}/{workSlug}", func(w http.ResponseWriter, r *http.Request) {
	...
	http.HandleFunc("GET /api/v1/getPublicWork", api.GetPublicWork(db))
