...
> 🚧 Я считаю, что код имеет серьезные проблемы с логикой. Проект не идеален, и его, я думаю, надо переделать чуть медленне и аккуратнее. Я продолжу делать фишки, но проект, конечно, лучше переписать.
